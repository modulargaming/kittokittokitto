 ...
 * @link 
http://blogs.igeek.com.au/DarkAz/blogpost/PHP_function_for_displaying_relative_dates_in_a_human_readable_format/
...
function smarty_modifier_timediff($timestamp)
{
    ...
    $periods = array("sec", "min", "hour", "day", "week", "month", 
"year", "decade");
