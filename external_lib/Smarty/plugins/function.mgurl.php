 ...
 * @return   string
 */ 
function smarty_function_mgurl($params, &$smarty)
{
    ...
    foreach($REQUIRED as $parameter)
    {
        ...
        {
            $smarty->trigger_error("mgurl: Required parameter '$parameter' not specified.");
        }
    } // end required check
