...
$uri->name(array("search", "keyword", "precision", "page"));
switch($_POST['state'])
{
    default:
    {
        if($_URI['keyword'] != "")
        {
          ...
          $SEARCH = array(
              'term' => stripinput(trim($_URI['keyword'])),
              'search' => strtolower(stripinput($_URI['search'])),
              'precision' => strtolower(stripinput($_URI['precision'])),
          );
    ...
    {
        $SEARCH = array(
            'term' => urlencode(stripinput($_POST['keyword'])),
            'search' => urlencode(stripinput($_POST['search'])),
            'precision' => urlencode(stripinput($_POST['match'])),
        );
