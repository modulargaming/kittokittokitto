<div align='center'>
    ...
    <table class='inputTable' width='30%' style='padding-bottom: 2em;'>
        ...
        <tr>
            ...
            <td class='inputTableRowAlt'>{mgurl link_text=$pet.owner.name slug='profile' args=$pet.owner.id}</td>
        </tr>
        ...
        <tr>
            <td colspan='2' style='text-align: center;' class='inputTableRow' style='font-size: large; font-weight: bold;'>{mgurl link_text='Edit Profile' slug='edit-pet' args=$pet.id}</td>
        </tr>
        {/if}
