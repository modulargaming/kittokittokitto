<p align='center'>{mgurl link_text='Inbox' slug='messages'}</p>

<div align='center'>
    <table class='inputTable' width='70%'>
         <tr>
            <td class='inputTableRow inputTableSubhead' width='8%'>From</td>
            <td class='inputTableRow'>{mgurl link_text=$message.from.name slug='profile' args=$message.from.id}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class='inputTableRowAlt' style='text-align: right;'>
                ...
                <form action='{$display_settings.public_dir}/write-message/{$message.id}' method='get' class='inline-form'>
                    <input type='hidden' name='state' value='reply' />
                    <input type='submit' value='Reply' />
                </form>
                <form action='{$display_settings.public_dir}/write-message/{$message.id}/all' method='get' class='inline-form'>
                    <input type='hidden' name='state' value='reply' />
