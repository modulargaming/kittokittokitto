        ...
        <div id='footer'>
            ...
            <p>{if $online_users != 1}{mgurl link_text="$online_users Users Online" slug='online'}{else}{mgurl link_text="$online_users User Online" slug='online'}{/if} | {mgurl link_text='Staff' slug='staff'} | {mgurl link_text='Terms and Conditions' slug='terms-and-conditions'}</p> 
