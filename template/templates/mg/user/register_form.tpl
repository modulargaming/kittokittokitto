...
<div align='center'>
    <form action='{$display_settings.public_dir}/{$self.slug}' method='post'>
        ...
        <table class='inputTable'>
			...
			<tr>
                <td class='inputTableRow inputTableSubhead'>
                    <label for='refid'>Referral</label>
                </td>
                <td class='inputTableRow' id='ref_id_td'>
				<input class="text" type="text" name="user[ref_id]" value="{$ref}"{if $ref != ""} disabled{/if}> <span class='tiny'> (Leave Blank If Unknown!)</span><br />
				</td>
            </tr>
            ...
            <tr>
                <td colspan='2' class='inputTableRowAlt' align='center'>
                    Registration indicates that you agree to abide by the {mgurl link_text='Terms and Conditions' slug='terms-and-conditions'}.
                </td>
            </tr>
