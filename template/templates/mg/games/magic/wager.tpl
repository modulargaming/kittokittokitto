<div align='center'>
    <div style='width: 40%;'>
        <p><em>I can do a magic trick! I have five cards. I want you to pick one, and then I'll tell you what card you picked! If I'm right, you have to give me {$cost|mgcurrency}, and if I lose, I'll give you {$prize|mgcurrency}!</em></p>
