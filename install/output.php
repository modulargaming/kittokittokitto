...
header("Content-Disposition: attachment; filename=config.inc.php");
		...
		$content .= "             * phpinfo() into the folder you want MG to live in and visit\n";
		...
		$content .= "\n";
		$content .= "			/**\n";
		$content .= "             * Standard template that will be used. \n";
		$content .= "             **/\n";
